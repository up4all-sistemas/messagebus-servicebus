...
{
    public class ServiceBusStandaloneSubscribeClientMocked : MessageBusStandaloneSubscribeClientMock, IMessageBusStandaloneConsumer, IServiceBusClient, IDisposable
    {
